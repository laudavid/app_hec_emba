...
st.markdown("""Recommendation systems are AI algorithms built to **suggest** or **recommend** **products** to consumers. 
            They help users discover products and services they might otherwise have not found on their own.
Recommender systems are built using two different techniques. The first is **Content-based filtering** where recommendations are made based on the user's own preferences.
...
st.markdown("""Common applications of Recommendantion ystems include:
