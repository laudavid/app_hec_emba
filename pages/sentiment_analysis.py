...
#if use_case == "Starbucks Customer Reviews (Text)":
st.markdown("#### Starbucks Customer Reviews ☕")
#st.image("images/coffee.jpg")
st.markdown("""In this use case, we are going to analyze the polarity (negative, neutral, positive) of Starbucks customer reviews by using Sentiment Analysis. <br>
An option for **writing your own review** and using sentiment analysis to assess its polarity is also available.""", 
