...
st.markdown("""Time series forecasting models are AI models built to make accurate predictions about future values using historical data. <br>
...
st.divider()
st.markdown("### Electrical Power Consumption Forecasting ⚡")

#st.markdown("  ")
st.markdown("""In this example, we built a time series forecasting model that predicts the **daily energy consumption of a household** (or *Global Active Power*) using historical data. <br>
